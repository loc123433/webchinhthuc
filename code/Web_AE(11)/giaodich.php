...
<div class="row">
	<div class="col-sm-12">
		<div style="text-align: center;">
			...
			<i>Quý khách sẽ sớm nhận được cuộc gọi xác nhận của chúng tôi, giá trị đơn hàng này là <b><?php echo number_format($money, 0, ","," ") ?> VND</b> và sẽ được thanh toán sau khi nhận hàng!</i>
...
$sql = "INSERT INTO giaodich VALUES ('',0,'".$user_id."','".$ten."','".$phuong."','".$dc."','".$sodt."','".$money."','".$now."')";
